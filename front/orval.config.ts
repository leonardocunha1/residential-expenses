...
const resolveOperationName = (operation: unknown, route: string, verb: string): string => {
  ...
  api: {
    ...
    output: {
      ...
      override: {
        ...
        operationName: (operation, route, verb) => resolveOperationName(operation, route, verb),
        query: {
          useQuery: true,
          useInfinite: true,
          useInfiniteQueryParam: "page", // Defina o padrão da sua API
        },
      },
    },
    hooks: {
